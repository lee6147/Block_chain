...
//  네트워크: .env의 NETWORK 값으로 선택 (giwa / base)
// ============================================================
...
async function main() {
  console.log('');
  console.log('  ============================================');
  console.log('   1단계:', NET.name, '잔액 + Nonce 확인');
  console.log('  ============================================');
  console.log('');
  ...
  console.log('  네트워크 :', NET.description);
  console.log('');
  ...
  console.log('');
  console.log(' ', NET.name, '(OP Stack L2) 특성:');
  ...
  if (balanceWei === 0n) {
    ...
    NET.faucets.forEach(function (f) { console.log('    ', f); });
  }
